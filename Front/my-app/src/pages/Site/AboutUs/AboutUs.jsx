...
You can find a lot of things about us.
          </p>
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-12">
    ...
    <div class="row">
      <div class="col-xl-8 col-lg-8 col-md-12 d-flex">
        ...
        <div class="abt-content wow fadeInUp animation-delay-6 animated style-HODEX" id="style-HODEX">
          <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
              <div class="abt-content-inner pt-50">
                <img src="https://cr7us.com/cdn/shop/files/DSC6528_final_2c799a2f-db9a-4003-a50a-e888d73d0426_800x.jpg?v=1699968911" alt="abt-img-1" class="radius-40"/>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6">
              <div class="abt-content-inner pt-50">
      ...
      <div class="col-xl-4 col-lg-4 col-md-12 d-flex">
        <div class="abt-img-2 full-img wow fadeInRight animated style-NljUq" id="style-NljUq">
          <img src="https://wallpaperset.com/w/full/6/9/3/155548.jpg" alt="abt-img-2" class="radius-40"/>
        </div>
      </div>
    </div>
  </div>
