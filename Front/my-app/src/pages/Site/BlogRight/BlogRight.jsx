      ...
      <div class=" col-xl-8 col-lg-8 col-md-12">
        <div class="blog-list-part wow fadeInLeft animated style-9vyBJ" id="style-9vyBJ">
          <div class="blog-singel-list">
            <div class="br blog-img">
              <Link onClick={scrollToTop} to="/BlogDetail">
                <img className='br' src="https://smithandquinn.com/cdn/shop/files/smith-_-quinn-womens-spring-sport-collection-camilla-golf-tennis-pickleball-dress-dandelion-haze-1_1600x.jpg?v=1701474529" alt="blog-list-1"/>
              </Link>
            </div>
          ...
          <div class="blog-singel-list">
            <div class=" br blog-img">
              <Link onClick={scrollToTop} to="/BlogDetail">
                <img className='br' src="https://i.pinimg.com/564x/7c/25/41/7c254199e9382536d99354113fbe1383.jpg" alt="blog-list-2"/>
              </Link>
            </div>
            <div class="blog-list-content">
              <div class="blog-date">
