...
<section class="our-story right-padding position-r mb-150 overflow-h snipcss-YXkPv style-gN9cP" id="style-gN9cP">
  <div class="black-jamun wow fadeInLeft animation-delay-5 animated style-48ObW" id="style-48ObW">
    <img src="https://t4.ftcdn.net/jpg/01/87/91/41/360_F_187914118_GYNR71jZ6seXtrFgKTbzfAFFVezesbwy.jpg" alt="Vacter Image"/>
  </div>
  <div class="story-onion wow fadeInUp animated style-by3AJ" id="style-by3AJ">
    <img className='or' src="https://c8.alamy.com/comp/2D50A18/football-ball-logo-in-gold-crown-vector-illustration-2D50A18.jpg " alt="Vacter Image"/>
  </div>
    ...
    <div class=" align-items-center wor">
      <div class=" wo wow fadeInLeft order-md_2 animated style-GpvIA " id="style-GpvIA">
        <div class="story-img text-center">
          <img src="https://cr7fragrances.store/cdn/shop/products/CR7-EDT-Bath-Gift-Shoebox-02-2048x2048_grande.jpg?v=1656943358" alt="Our Story"/>
        </div>
      </div>
      <div class=" wow wr fadeInRight order-md_1 animated style-IGI1Y" id="style-IGI1Y">
        ...
        The embodiment of  <br /> perfection
          </h2>
        </div>
...
<section class="feeddback-part position-r mb-150 overflow-h snipcss0-0-0-1 snipcss-aaBv9">
  <div class="feeddback-vacter wow fadeInLeft animation-delay-5 animated snipcss0-1-1-2 style-5AFpT" id="style-5AFpT">
    <img src="https://upload.wikimedia.org/wikipedia/commons/0/0c/Sport_balls.svg" alt="Vacter Image" class="snipcss0-2-2-3"/>
  </div>
